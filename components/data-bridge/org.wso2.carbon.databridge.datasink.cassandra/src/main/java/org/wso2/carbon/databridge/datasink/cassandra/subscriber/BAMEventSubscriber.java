...
public class BAMEventSubscriber implements AgentCallback {
    ...
    public void definedStream(StreamDefinition streamDefinition, Credentials credentials) {
        /*StreamSubscriber streamSubscriber = StreamSubscriber.getInstance();
        try {
            PrivilegedCarbonContext.startTenantFlow();
            PrivilegedCarbonContext.getThreadLocalCarbonContext().setTenantDomain(credentials.getDomainName(), true);
