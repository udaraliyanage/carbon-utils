...
public class IndexDefinition {
    ...
    public void setIndexData(String indexDefnStr, StreamDefinition streamDefinition) {
        ...
        Set<String> arbitraryIndexSet = null;       //arbitrary index field has been added later
        if (indexData.length > 4) {
            arbitraryIndexSet = new HashSet<String>(Arrays.asList(indexData[4].split(",")));
        }
        ...
        if(arbitraryIndexSet != null) {
            arbitraryIndexData = new ArrayList<Attribute>(arbitraryIndexSet.size());
            for(String arbitraryIndexField : arbitraryIndexSet) {
